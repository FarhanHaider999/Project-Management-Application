  ...
  return (
    ...
    <div className='flex h-[100%] w-full flex-col justify-start'>
      ...
      <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
        ...
        {showPriority && (
          <>
          <SidebarLink icon = {AlertCircle} label= "Urgent" href='/urgent' />
          <SidebarLink icon = {ShieldAlert} label= "High" href='/high' />
          <SidebarLink icon = {AlertTriangle} label= "Medium" href='/medium' />
          <SidebarLink icon = {AlertOctagon} label= "Low" href='/low' />
